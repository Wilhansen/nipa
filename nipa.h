...
TCHAR games[][20] = { _T("ChaosHead"), _T("ChaosHeadTr1"), _T("ChaosHeadTr2"), _T("MuramasaTr"), _T("Muramasa"), _T("Sumaga"), _T("Django"), _T("DjangoTr"),
	_T("Lamento"), _T("LamentoTr"), _T("sweetpool"), _T("SumagaSP"), _T("Demonbane"), _T("MuramasaAD"), _T("Axanael"), _T("Kikokugai"), _T("SonicomiTr2"), _T("Sumaga3P"), _T("Sonicomi"), _T("\0") };
enum { CHAOSHEAD = 0, CHAOSHEADTR1, CHAOSHEADTR2, MURAMASATR, MURAMASA, SUMAGA, DJANGO, DJANGOTR,
	LAMENTO, LAMENTOTR, SWEETPOOL, SUMAGASP, DEMONBANE, MURAMASAAD, AXANAEL, KIKOKUGAI, SONICOMITR2, SUMAGA3P, SONICOMI };
